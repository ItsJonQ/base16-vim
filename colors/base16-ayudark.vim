" Base16 Ayu Dark (https://github.com/chriskempson/base16)
...
if !has('gui_running')
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/base16-ayudark.".&background.".sh"
  endif
endif
...
let g:colors_name = "base16-ayudark"
