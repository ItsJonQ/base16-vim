" Base16 Drac (https://github.com/chriskempson/base16)
...
if !has('gui_running')
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/base16-drac.".&background.".sh"
  endif
endif
...
let s:gui08Dark = "b0b2cb"
let s:gui09Dark = "b0b2cb"
let s:gui0ADark = "b0b2cb"
let s:gui0BDark = "b0b2cb"
let s:gui0CDark = "b0b2cb"
let s:gui0DDark = "b0b2cb"
let s:gui0EDark = "b0b2cb"
let s:gui0FDark = "b0b2cb"
