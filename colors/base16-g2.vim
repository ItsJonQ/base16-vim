" Base16 G2 (https://github.com/chriskempson/base16)
...
if !has('gui_running')
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/base16-g2.".&background.".sh"
  endif
endif
...
let s:gui0BDark = "279f76"
let s:gui0CDark = "12161e"
let s:gui0DDark = "279f76"
let s:gui0EDark = "279f76"
