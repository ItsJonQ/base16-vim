" Base16 G3 (https://github.com/chriskempson/base16)
...
if !has('gui_running')
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/base16-g3.".&background.".sh"
  endif
endif
...
let s:gui0BDark = "a6542a"
let s:gui0CDark = "12161e"
let s:gui0DDark = "a6542a"
let s:gui0EDark = "a6542a"
