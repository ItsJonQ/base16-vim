" Base16 Gotham (https://github.com/chriskempson/base16)
...
if !has('gui_running')
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/base16-gotham.".&background.".sh"
  endif
endif
...
let s:gui0BDark = "2b9472"
let s:gui0CDark = "10131a"
let s:gui0DDark = "2b9472"
let s:gui0EDark = "2b9472"
