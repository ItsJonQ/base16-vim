" Base16 Lucio (https://github.com/chriskempson/base16)
...
if !has('gui_running')
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/base16-lucio.".&background.".sh"
  endif
endif
...
let s:gui0DDark = "85b525"
let s:gui0EDark = "85b525"
...
let g:colors_name = "base16-lucio"
