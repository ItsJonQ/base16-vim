" Base16 NightHawk (https://github.com/chriskempson/base16)
...
if !has('gui_running')
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/base16-nighthawk.".&background.".sh"
  endif
endif
...
let s:gui09Dark = "984242"
let s:gui0ADark = "984242"
let s:gui0BDark = "00787d"
let s:gui0CDark = "6973c1"
let s:gui0DDark = "375cae"
let s:gui0EDark = "7b399e"
let s:gui0FDark = "cc4873"
...
let g:colors_name = "base16-nighthawk"
