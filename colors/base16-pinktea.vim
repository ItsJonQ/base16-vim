" Base16 Pink Tea (https://github.com/chriskempson/base16)
...
if !has('gui_running')
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/base16-pinktea.".&background.".sh"
  endif
endif
...
let s:gui0BDark = "ac7cac"
let s:gui0CDark = "ac7cac"
...
let g:colors_name = "base16-pinktea"
