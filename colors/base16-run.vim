" Base16 Run (https://github.com/chriskempson/base16)
...
if !has('gui_running')
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/base16-run.".&background.".sh"
  endif
endif
...
let s:gui09Dark = "231e2a"
let s:gui0ADark = "cc9250"
let s:gui0BDark = "50b5ca"
let s:gui0CDark = "50b5ca"
let s:gui0DDark = "231e2a"
let s:gui0EDark = "892b48"
