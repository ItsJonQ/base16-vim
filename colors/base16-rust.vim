" Base16 Rust (https://github.com/chriskempson/base16)
...
if !has('gui_running')
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/base16-rust.".&background.".sh"
  endif
endif
...
let s:gui08Dark = "b26d72"
let s:gui09Dark = "bc9273"
let s:gui0ADark = "bca26f"
let s:gui0BDark = "829870"
let s:gui0CDark = "789190"
let s:gui0DDark = "72818f"
let s:gui0EDark = "967a90"
let s:gui0FDark = "b26d72"
