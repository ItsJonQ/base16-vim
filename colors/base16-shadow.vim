" Base16 Shadow (https://github.com/chriskempson/base16)
...
if !has('gui_running')
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/base16-shadow.".&background.".sh"
  endif
endif
...
let s:gui09Dark = "cc9356"
let s:gui0ADark = "c1c870"
let s:gui0BDark = "40c862"
let s:gui0CDark = "81bfb6"
let s:gui0DDark = "52aebf"
let s:gui0EDark = "8b67cc"
...
let g:colors_name = "base16-shadow"
