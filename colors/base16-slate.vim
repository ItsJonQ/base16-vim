" Base16 Slate (https://github.com/chriskempson/base16)
...
if !has('gui_running')
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/base16-slate.".&background.".sh"
  endif
endif
...
let s:gui0DDark = "10131a"
let s:gui0EDark = "10131a"
