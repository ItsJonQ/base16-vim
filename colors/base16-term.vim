...
if !has('gui_running')
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/base16-term.".&background.".sh"
  endif
endif
...
let s:gui08Dark = "b60000"
let s:gui09Dark = "b600b4"
let s:gui0ADark = "b7ba26"
let s:gui0BDark = "00ca2a"
let s:gui0CDark = "1eb8b8"
let s:gui0DDark = "0900c9"
let s:gui0EDark = "b600b4"
let s:gui0FDark = "b60000"
