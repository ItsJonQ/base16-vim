" Base16 Terminal (https://github.com/chriskempson/base16)
...
if !has('gui_running')
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/base16-terminal.".&background.".sh"
  endif
endif
...
let s:gui09Dark = "ca5ac9"
let s:gui0ADark = "9f9e1e"
let s:gui0BDark = "52ca5b"
let s:gui0CDark = "4d5581"
let s:gui0DDark = "1030a4"
let s:gui0EDark = "ca5ac9"
let s:gui0FDark = "bc5956"
...
let g:colors_name = "base16-terminal"
