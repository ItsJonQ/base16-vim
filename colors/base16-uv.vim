" Base16 UV (https://github.com/chriskempson/base16)
...
if !has('gui_running')
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/base16-uv.".&background.".sh"
  endif
endif
...
let s:gui09Dark = "20232a"
let s:gui0ADark = "b9841d"
let s:gui0BDark = "629966"
let s:gui0CDark = "20232a"
let s:gui0DDark = "629966"
let s:gui0EDark = "cc3264"
let s:gui0FDark = "20232a"
