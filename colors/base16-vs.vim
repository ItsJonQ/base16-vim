" Base16 VS (https://github.com/chriskempson/base16)
...
if !has('gui_running')
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/base16-vs.".&background.".sh"
  endif
endif
...
let s:gui08Dark = "457dab"
let s:gui09Dark = "a57460"
let s:gui0ADark = "cccccc"
let s:gui0BDark = "a66c5a"
