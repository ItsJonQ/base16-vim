" Base16 xorange (https://github.com/chriskempson/base16)
...
if !has('gui_running')
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/base16-xorange.".&background.".sh"
  endif
endif
...
let s:gui0CDark = "cc8933"
let s:gui0DDark = "cc8933"
let s:gui0EDark = "cc8933"
let s:gui0FDark = "cc8933"
...
let g:colors_name = "base16-xorange"
