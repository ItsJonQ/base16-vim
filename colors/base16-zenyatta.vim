" Base16 Zenyatta (https://github.com/chriskempson/base16)
...
if !has('gui_running')
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/base16-zenyatta.".&background.".sh"
  endif
endif
...
let s:gui0BDark = "cbba3e"
let s:gui0CDark = "c0c0c1"
let s:gui0DDark = "cbba3e"
let s:gui0EDark = "cbba3e"
...
let g:colors_name = "base16-zenyatta"
